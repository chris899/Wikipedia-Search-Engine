...
public class AutoComplete {
	JTextField f ;
	boolean ff = false;
	QueryThread queryThreadd;
	public AutoComplete() {
		
	}
    public AutoComplete(ArrayList<String> w,QueryThread qq) {
    ...
    public  JTextField mmain(ArrayList<String> wo, QueryThread queryThread) {
        this.ff = false;
        this.queryThreadd = queryThread;
    	SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new AutoComplete(wo,queryThread);
    ...
    public void setSearchedQuery(JTextField w) {
    	this.f = w;
    }
